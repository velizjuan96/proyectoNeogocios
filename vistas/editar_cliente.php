...
include '../jquery/editar_cliente.php';
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li><a class="ajax-request" href="cliente.php">cliente</a></li>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="modal-footer d-flex justify-content-center">
                                                <button class="btn btn-deep-orange" id="editar_cliente">Enviar</button>
                                            </div>
