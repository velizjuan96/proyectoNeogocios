...
<html>
<?php
include '../jquery/eliminar_producto.php'
//?>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <?php
        echo include '../modal/producto.php';
        ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">Listado de Clientes
                            ...
                            <div class="text-center">
                                <a href="" class="btn btn-primary btn-lg"
                                   data-toggle="modal"
                                   data-target="#modalRegisterForm">Nuevo Producto</a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="col-md-12 ">
                                ...
                                $busqueda = $conexion->query("Select * from producto");
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    foreach ($arrDatos as $muestra) {
                                        ...
                                        echo '<td >' . $muestra['fecha_compra'] . '</td>';
                                        echo '<td >' . $muestra['fecha_vencimiento'] . '</td>';

                                        echo '<td>
                  <a class="btn btn-danger ajax-request" id="eliminar_producto"  data-target="' .$muestra['Id'] .'">   
                  <i class="fa fa-trash"></i>
                  </a>
                  
                <a class="btn btn-primary " id="editar" href="editar_producto.php?id=' . $muestra['Id'] . ' ">
