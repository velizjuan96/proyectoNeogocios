...
include '../jquery/editar_producto.php';
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="venta.php"><i class="fa fa-link"></i> <span>Ventas</span>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li><a class="ajax-request" href="producto.php">Producto</a></li>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="modal-footer d-flex justify-content-center">
                                                <button class="btn btn-deep-orange" id="editar_producto">Enviar</button>
                                            </div>
