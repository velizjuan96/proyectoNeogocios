    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li><a class="ajax-request" href="">Venta</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">
                        <a href="" class="btn btn-primary btn-lg" style="Position:Absolute; left:1%; top:-15%" data-toggle="modal"
                ...
                <a class="btn btn-primary ajax-request" id="editar" href="editar_venta.php?id='.$muestra['Id'].' ">
