...
<html>
<?php
include '../jquery/eliminar_vendedor.php'
//?>
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <?php
        echo include '../modal/vendedor.php';
        ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Listado de Vendedores
                            <div class="text-center">
                                <a href="" class="btn btn-primary btn-lg"
                                   data-toggle="modal"
                                   data-target="#modalRegisterForm">Nueva Vendedor</a>
                            </div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12 ">
                                ...
                                $busqueda = $conexion->query("Select * from vendedores");
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    foreach ($arrDatos as $muestra) {
                                        ...
                                        echo '<td>
                  <a class="btn btn-danger ajax-request" id="eliminar_vendedor"  data-target="' . $muestra['Id'] . '">
