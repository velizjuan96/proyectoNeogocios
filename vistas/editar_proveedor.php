...
include '../jquery/editar_proveedor.php';
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li><a class="ajax-request" href="proveedores.php">Proveedor</a></li>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <form id="formulario" method="post">
                                                ...
                                                <div class="md-form mb-5">
                                                    ...
                                                    <input type="text" id="orangeForm-name" name="nombre_empresa" class="form-control validate">
                                            ...
                                            <div class="modal-footer d-flex justify-content-center">
                                                <button class="btn btn-deep-orange" id="editar_proveedor">Enviar</button>
                                            </div>
