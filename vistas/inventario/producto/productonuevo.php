            ...
            <form method="post" action="#" id="formulario">
              ...
              <div class="col-sm-6">
                ...
                <input type="text" name="codigo_barra" id="codigo_barra"  class="form-control"/>
							...
							<div class="col-sm-12">
								<label class='control-sidebar-subheading' for="fecha">Categoria</label>
                    ...
                    include($_SERVER['DOCUMENT_ROOT'].'/sistema/modelo/conexion.php');
							...
							<div class="col-sm-12">
								<label class='control-sidebar-subheading' for="fecha">Proveedores</label>
								<select name="proveedor" id="proveedor" class="form-control" id="inputGroupSelect">
									<option selected>Seleccione</option>
									<?php
                	...
                	<option selected>Seleccione</option>
							...
							<div class="col-sm-6">
								...
								<select name="unidades" id="unidades" class="form-control" id="inputGroupSelect">
									<option selected>Seleccione</option>
