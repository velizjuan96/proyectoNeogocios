...
<?php
include '../jquery/insertar_cliente.php'
?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Registro de Nuevo Cliente</h4>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button class="btn btn-deep-orange" id="ingresar_cliente">Enviar</button>
                </div>
